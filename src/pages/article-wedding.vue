<template>
  <div class="zenekar-eskuvore tab article">
    <div class="inner">
      <h2>${data.title}</h2>
      <div class="row">
        <div class="columns small-12 medium-12 desktop12">
          ...
          <img alt="" class="left" src="assets/img/cycle/img2.jpg">Esküvő… Amikor meghalljuk ezt a szót, mindannyiunknak egy csodálatos esemény jut az eszébe. Kevés meghatóbb dolog van az életben annál, mint amikor két ember – családjuk és barátaik körében – örök hűséget fogadnak egymásnak. A ceremóniát követő ünnepi vacsora után viszont a szórakozásé a főszerep, de ehhez mindenképpen szükség van egy olyan esküvői zenekar-ra, amely megfelelő hangulatot tud teremteni az est további részében.<br>
          <br>
